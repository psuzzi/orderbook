...
public class MinIndexedDHeap<T> {
    ...
    public MinIndexedDHeap(int degree, int maxSize, Comparator<T> comparator) {
    ...
    void resize(int capacity){
        ...
        int[] imTemp = new int[N];
        int[] pmTemp = new int[N];
        int[] childTemp = new int[N];
        int[] parentTemp = new int[N];
        Object[] valuesTemp = new Object[N];
    ...
    private boolean less(int i, int j) {
        return comparator.compare((T) values[im[i]], (T) values[im[j]])<0;
    }
